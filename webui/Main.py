...
def _sync_chatterbox_config_from_session_state():
    ...
    submitted_chatterbox_api_key = st.session_state.get("chatterbox_api_key_input")
    if submitted_chatterbox_api_key:
        config.chatterbox["api_key"] = submitted_chatterbox_api_key
    ...
    with st.container(border=True):
        ...
        if selected_tts_server == "elevenlabs" or (
            ...
            elevenlabs_api_key = st.text_input(
                ...
                placeholder="Saved key configured" if saved_elevenlabs_api_key else "",
            )
        ...
        if selected_tts_server == "chatterbox" or (
            ...
            chatterbox_api_key = st.text_input(
                ...
                placeholder=(
                    ...
                    if config.chatterbox.get("api_key", "")
                    else ""
                ),
            )
