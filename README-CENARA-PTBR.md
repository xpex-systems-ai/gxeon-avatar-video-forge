...
Cenara é uma revisão privada de MVP sobre o upstream MoneyPrinterTurbo, mantendo a atribuição e a licença MIT originais do projeto. Esta versão não é um produto público, não adiciona cobrança SaaS, login de clientes, autoposting ou integrações comerciais novas.

## Polimento de segurança de chaves

- As chaves de provedores de vídeo (Pexels, Pixabay e Coverr) aparecem mascaradas no WebUI; a seleção para exclusão usa o rótulo mascarado, mas preserva internamente a chave original correta para remover.
